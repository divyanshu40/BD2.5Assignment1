...
app.get("/products/filter/ram", (req, res) => {
  ...
  let filteredProducts = products.filter((product) => filterByRam(product, ram));
...
app.get("/products/filter/rom", (req, res) => {
  ...
  let filteredProducts = products.filter((product) => filterByRom(product, rom));
  res.json({ filteredProducts: filteredProducts });
});
...
app.get("/products/filter/brand", (req, res) => {
  ...
  let filteredProducts = products.filter((product) => filterByBrand(product, brand));
  res.json({filteredProducts: filteredProducts });
});
...
app.get("/products/filter/price", (req, res) => {
  ...
  let filteredProducts = products.filter((product) => filterByPrice(product, price));
  res.json({ filteredProducts: filteredProducts });
});
